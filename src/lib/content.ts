...
export const content = {
  es: {
    ...
    hero: {
      ...
      titlePost: ".",
      subtitle:
        "Diseño tu sistema de captación, cualificación y cierre en Go High Level, potenciado con IA. Agentes de IA, formularios, WhatsApp y propuestas conectados en un solo flujo automático.",
      ...
      offering: [
        "Agentes de IA para captar y cualificar leads",
    ...
    sobreMi: {
      ...
      specialties: [
        ...
        "Funnels y nurturing",
        "Agentes de IA e integraciones por API",
      ],
  ...
  en: {
    ...
    hero: {
      ...
      titlePost: ".",
      subtitle:
        "I design your lead capture, qualification and closing system on Go High Level, powered by AI. AI agents, forms, WhatsApp and proposals connected in a single automated flow.",
      ...
      offering: [
        "AI agents to capture and qualify leads",
